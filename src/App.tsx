    ...
    <main className="App-main">
     <div className="test-section">
      ...
      <p className="test-text">
       이 텍스트를 드래그하여 선택하면 플로팅 UI가 나타납니다. 플로팅 UI에서는 요약, 번역, 설명,
       다시쓰기 기능을 테스트할 수 있습니다.
      </p>
      <p className="test-text">
       Christoffel is an AI-powered Chrome extension that helps you process text with various AI
       features. Select this text to see the floating UI in action.
      </p>
     </div>
